...
class OptimizedConsumption(db.Model):
    fields_map = None
    ...
    device = db.relationship("Device", back_populates="optimized_consumptions")
    real_consumption = db.relationship(
        "Consumption", back_populates="optimized_consumption"
    )
